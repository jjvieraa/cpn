...
Begin VB.Form fjDatos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmdatos.frx":0000
      ...
      TabPicture(1)   =   "frmdatos.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "cmdDelEstCivil"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "txtEstCiv"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "cmdSaveEstCiv"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "Frame4"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "adoEstCiv"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "DGEstCiv"
      ...
      TabCaption(2)   =   "Grado"
      TabPicture(2)   =   "frmdatos.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "cmdDelGdo"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "txtGdo"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "cmdSaveGdo"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "Frame5"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "adoGrado"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "DGGdo"
      ...
      TabPicture(3)   =   "frmdatos.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "cmdDelSitLab"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "txtSitLab"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "cmdSaveSitLab"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "Frame2"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "adoSLaboral"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "DGSitLab"
      ...
      TabPicture(4)   =   "frmdatos.frx":0070
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "cmdDelUniPer"
      Tab(4).Control(0).Enabled=   0   'False
      Tab(4).Control(1)=   "txtUniPer"
      Tab(4).Control(1).Enabled=   0   'False
      Tab(4).Control(2)=   "cmdSaveUniPer"
      Tab(4).Control(2).Enabled=   0   'False
      Tab(4).Control(3)=   "Frame1"
      Tab(4).Control(3).Enabled=   0   'False
      Tab(4).Control(4)=   "adoUniPer"
      Tab(4).Control(4).Enabled=   0   'False
      Tab(4).Control(5)=   "DGUniPer"
      ...
      TabPicture(5)   =   "frmdatos.frx":008C
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "cmdDelUniSer"
      Tab(5).Control(0).Enabled=   0   'False
      Tab(5).Control(1)=   "txtUniSer"
      Tab(5).Control(1).Enabled=   0   'False
      Tab(5).Control(2)=   "cmdSaveUniSer"
      Tab(5).Control(2).Enabled=   0   'False
      Tab(5).Control(3)=   "Frame6"
      Tab(5).Control(3).Enabled=   0   'False
      Tab(5).Control(4)=   "DGUniSer"
      Tab(5).Control(4).Enabled=   0   'False
      Tab(5).Control(5)=   "adoUniSer"
      ...
      TabCaption(6)   =   "Grupos"
      TabPicture(6)   =   "frmdatos.frx":00A8
      Tab(6).ControlEnabled=   -1  'True
      Tab(6).Control(0)=   "Label13"
      Tab(6).Control(0).Enabled=   0   'False
      Tab(6).Control(1)=   "Label14"
      Tab(6).Control(1).Enabled=   0   'False
      Tab(6).Control(2)=   "DataGrid2"
      Tab(6).Control(2).Enabled=   0   'False
      Tab(6).Control(3)=   "adoGrupo"
      Tab(6).Control(3).Enabled=   0   'False
      Tab(6).Control(4)=   "txtGrupos"
      Tab(6).Control(4).Enabled=   0   'False
      Tab(6).Control(5)=   "Frame7"
      Tab(6).Control(5).Enabled=   0   'False
      Tab(6).ControlCount=   6
      TabCaption(7)   =   "Parámetros"
      TabPicture(7)   =   "frmdatos.frx":00C4
      Tab(7).ControlEnabled=   0   'False
      Tab(7).Control(0)=   "txtOrden"
      Tab(7).Control(0).Enabled=   0   'False
      Tab(7).Control(1)=   "cmdGrabarParam"
      Tab(7).Control(1).Enabled=   0   'False
      Tab(7).Control(2)=   "cmdSalir(7)"
      Tab(7).Control(2).Enabled=   0   'False
      Tab(7).Control(3)=   "mskUltimo"
...
Private Sub Form_Load()
    ...
    Else
        SSTab1.TabVisible(8) = False
    End If
    SSTab1.TabVisible(7) = False    'no se usa mas
End Sub
